...
tail -n +2 $1 | awk -F"," '{print $1}' | sed 's/_/ /g' | sed 's/"//g' | taxonkit name2taxid --data-dir data/lineage_information | taxonkit lineage --data-dir data/lineage_information --taxid-field 2 -R > data/lineage_information/lineage_information.csv
