...
date: "`r format(Sys.time(), '%d %B, %Y - %R %Z')`"
...
p %>% layout(autosize = F, width = 10, height = 10, showlegend=FALSE) %>% config(displayModeBar=FALSE)# this works only in combination with the print statement above
