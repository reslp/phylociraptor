...
```{r ext-figures, echo=FALSE, fig.width = 11.7}
...
if (identical(f, character(0)) == FALSE) {
	...
	colnames(data) <- c("combination", "alignment", "length", "nseqs", "nparsimony", "nvariable", "nfixed")	
	plotlist <- list()
	i <- 1
	cols <- c("#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf")
