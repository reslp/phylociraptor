...
```{r busco_summary, results="asis", echo=FALSE}
# this is just a quick way to display some summary statistics for the orthofinder run. This needs to be improved!
for (line in readLines(paste0("../results/orthology/orthofinder/orthofinder-",py$orthology_hash, "/orthofinder-results-", py$orthology_hash, "/Comparative_Genomics_Statistics/Statistics_Overall.tsv"))) {
	cat(paste0(line, "<br>"))
  } 
```
