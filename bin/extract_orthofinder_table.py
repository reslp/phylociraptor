...
pars = argparse.ArgumentParser(prog="extract_orthofinder_table.py", description = """This script will parse the Orthogroups.GeneCount.tsv file and extract only orthogroups with one or zero genes per species.""", epilog = """written by Philipp Resl""")
